...
<head>
    ...
    <link rel="stylesheet" href="recursos/css/calculadora.css">
    <title>Desafio</title>
</head>
<body class="desafio">
<header class="cabecalho">
        <h1>Desafio WS Solutions</h1>
        <h2>Formulário com PHP</h2>
    </header>
    <nav class="navegacao">
        ...
        <h2>Cadastro</h2>
            ...
            if(count($_POST) > 0) {
                ...
                if (!filter_var($_POST['salario'],
                    ...
                    $data = $_POST['nome'] . ' ' . $_POST['nascimento'] . ' ' . $_POST['filhos'] . ' ' .  $_POST['email'] . ' ' .  $_POST['site'] . ' ' .  $_POST['salario'] ."\n";
